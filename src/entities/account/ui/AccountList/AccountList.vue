...
import {
  type Account,
  AccountTypes,
} from "@src/entities/account/types/account.types.ts";
import AccountItem from "@src/entities/account/ui/AccountList/AccountItem.vue";
...
<template>
  <table class="w-[1000px]">
    ...
    <AccountItem
      ...
      @on-account-delete="accountStore.deleteAccount(index)"
      :account-index="index"
      :account="account"
    ></AccountItem>
  </table>
